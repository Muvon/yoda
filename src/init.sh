...
sed 's/{{driver}}/host/g' "$YODA_PATH/templates/compose.yml" > "$yoda_dir/containers/production.yml"
sed 's/{{driver}}/bridge/g' "$YODA_PATH/templates/compose.yml" > "$yoda_dir/containers/dev.yml"
